...
The output of the Notebook run is also provided as an [HTML file](https://github.com/russom/CarND-Traffic-Sign-Classifier-Project-RussoM/blob/master/writeup.md), to avoiding the re-training of the network.
